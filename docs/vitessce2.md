...
We store these to a companion `.offsets.json` file, making it more efficient to load image subsets.
We use a file generated by the [transform](https://lamin.ai/laminlabs/lamindata/transform/WVB7Q3xLWAnl) above.
